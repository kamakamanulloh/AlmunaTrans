...
public class Booking3Activity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
...
//        jml=Integer.parseInt(getIntent().getStringExtra("jml_penumpang").substring(0, 1));
        totharga = 3 * Integer.parseInt(getIntent().getStringExtra("harga"));
        ...
        profilResponseCall.enqueue(new Callback<Login_Response>() {
            ...
            public void onResponse(Call<Login_Response> call, Response<Login_Response> response) {
                ...
                if (value == 1) {
                    ...
                    ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(Booking3Activity.this, android.R.layout.simple_spinner_item, categories);
                    ...
                    Toast.makeText(Booking3Activity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<Login_Response> call, Throwable t) {
                Toast.makeText(Booking3Activity.this, "Gagal", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    @OnClick({R.id.tv_berangkat, R.id.tv_jam_berangkat, R.id.btn_lanjutkan})
    ...
    private void boking() {
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        APIService apiService = retrofit.create(APIService.class);
        Call<BookingResponse> call = apiService.booking3(tvkode.getText().toString(),
        ...
        call.enqueue(new Callback<BookingResponse>() {
            ...
            public void onResponse(Call<BookingResponse> call, Response<BookingResponse> response) {
                ...
                if (value == 1) {
                    Intent intent = new Intent(Booking3Activity.this, PilihKursiActivity.class);
