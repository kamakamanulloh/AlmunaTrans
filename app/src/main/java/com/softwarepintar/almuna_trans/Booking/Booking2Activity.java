...
//        jml=Integer.parseInt(getIntent().getStringExtra("jml_penumpang").substring(0, 1));
        ...
        totharga =2 * Integer.parseInt(getIntent().getStringExtra("harga"));
...
//        tvHarga.setText(getIntent().getStringExtra("jumlah"));
        ...
        if (getIntent().getStringExtra("is_pulangpergi").equalsIgnoreCase("y")){
            ...
            allHarga=(totharga+totharga_kembali)*2+kode;
        }
        ...
        profilResponseCall.enqueue(new Callback<Login_Response>() {
            ...
            public void onResponse(Call<Login_Response> call, Response<Login_Response> response) {
                ...
                if (value == 1) {
                    ...
                    ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(Booking2Activity.this, android.R.layout.simple_spinner_item, categories);
                    ...
                    Toast.makeText(Booking2Activity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<Login_Response> call, Throwable t) {
                Toast.makeText(Booking2Activity.this, "Gagal", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void booking() {
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        APIService apiService = retrofit.create(APIService.class);
        Call<BookingResponse> call = apiService.booking2(tvkode.getText().toString(),
        ...
        call.enqueue(new Callback<BookingResponse>() {
            ...
            public void onResponse(Call<BookingResponse> call, Response<BookingResponse> response) {
                ...
                if (value == 1) {
                    Intent intent = new Intent(Booking2Activity.this, PilihKursiActivity.class);
