...
import com.softwarepintar.almuna_trans.ui.profil.ResetPasswordActivity;
...
public class LupaSandiActivity extends AppCompatActivity {
    ...
    private void simpan() {
        ...
        Call<Register_Response> call=apiService.edit_password(getIntent().getStringExtra("userid"),txtsandi.getText().toString());
        call.enqueue(new Callback<Register_Response>() {
            ...
            public void onResponse(Call<Register_Response> call, Response<Register_Response> response) {
                ...
                if (value==1){
                    Toast.makeText(LupaSandiActivity.this, messages, Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<Register_Response> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(LupaSandiActivity.this, "Failure", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
