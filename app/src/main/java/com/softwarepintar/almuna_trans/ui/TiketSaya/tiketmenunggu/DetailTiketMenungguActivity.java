...
public class DetailTiketMenungguActivity extends AppCompatActivity {
    ...
    private PenumpangMenungguAdapter penumpangMenungguAdapterAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_tiket_menunggu);
        ButterKnife.bind(this);
        Locale localeID = new Locale("in", "ID");
        NumberFormat formatRupiah = NumberFormat.getCurrencyInstance(localeID);
        penumpangMenungguAdapterAdapter= new PenumpangMenungguAdapter(this, penumpangResultItemList);
...
//        Toast.makeText(this, batas_bayar+" "+kdbayar+" "+total, Toast.LENGTH_SHORT).show();
        ...
        rvpenumpang.setAdapter(penumpangMenungguAdapterAdapter);
        ...
        call.enqueue(new Callback<PenumpangResponse>() {
            ...
            public void onResponse(Call<PenumpangResponse> call, Response<PenumpangResponse> response) {
                ...
                if (Response_Item==1){
                    ...
                    penumpangMenungguAdapterAdapter = new PenumpangMenungguAdapter(DetailTiketMenungguActivity.this, penumpangResultItemList);

                    rvpenumpang.setAdapter(penumpangMenungguAdapterAdapter);
                }
                else{

                    Toast.makeText(DetailTiketMenungguActivity.this, "Gagal", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public void onViewClicked() {
        Intent intent = new Intent(DetailTiketMenungguActivity.this, PembayaranActivity.class);
        batas_bayar = tiketResultItem.getBatas_bayar();
        total = tiketResultItem.getNominal();
        kdbayar = tiketResultItem.getKodeTiket();
        intent.putExtra("qty",tiketResultItem.getJumlah());
